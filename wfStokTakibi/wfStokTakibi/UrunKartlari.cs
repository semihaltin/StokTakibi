                    ...
                    if (kayitno > 0)
                    {
                        ...
                        if (Sonuc)
                        {
                            ...
                            if (ch.CariHareketEkle(ch))
                            {
                                ...
                                Cari c = new Cari();
                                Sonuc = c.CariToplamlariGuncelleFromUrunHareket(ch.CariNo, ch.Borc, ch.Alacak);
                                if (Sonuc)
                                {
                ...
                if (Sonuc)
                {
                    ...
                    if (Sonuc)
                    {
                        ...
                        if (ch.CariHareketSil(Convert.ToInt32(txtHareketID.Text)))
                        {
                            ...
                            //Cari Toplamlar güncellenmeli...
                            Cari c = new Cari();
                            Sonuc = c.CariToplamlariGuncelleFromUrunHareket(Convert.ToInt32(txtCariNo.Text), Borc, Alacak);
                            if (Sonuc)
                            {
                                MessageBox.Show("Cari toplamlar güncellendi!");
                            }
